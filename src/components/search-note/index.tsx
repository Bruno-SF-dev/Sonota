...
export const NoteSearch = () => {
  ...
  return (
    <div className="flex max-w-6xl justify-between flex-col md:flex-row md:items-center gap-8 md:gap-4">
      <img src={logo} alt="NLW Experts" className="h-10 md:h-16" />

      <form
        onSubmit={handleSearchNote}
        className="w-full md:max-w-md flex rounded-md overflow-hidden"
      >
